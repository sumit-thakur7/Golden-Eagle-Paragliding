    ...
    <div>
      ...
      <section className="pt-32 pb-16 bg-gradient-cta bg-cover bg-center">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-headline font-bold text-4xl sm:text-5xl text-white mb-4">Contact Us</h1>
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              <div className="lg:w-2/5">
                <div className="bg-card p-6 sm:p-8 rounded-xl shadow-lg mb-8">
                  <h2 className="font-headline font-bold text-xl sm:text-2xl text-foreground mb-6">Contact Information</h2>
                ...
                <div className="bg-card p-6 sm:p-8 rounded-xl shadow-lg">
                  <h2 className="font-headline font-bold text-xl sm:text-2xl text-foreground mb-6">Connect With Us</h2>
              ...
              <div className="lg:w-3/5">
                <div className="bg-card p-6 sm:p-8 rounded-xl shadow-lg">
                  <h2 className="font-headline font-bold text-xl sm:text-2xl text-foreground mb-6">Send Us a Message</h2>
      ...
      {/* Final CTA Section */}
       <AnimatedSection>
        <section className="py-20 bg-gradient-cta bg-cover bg-center bg-fixed text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="font-headline font-bold text-3xl md:text-4xl mb-6">Ready to Take Flight?</h2>
