    ...
    <div>
        ...
        <section className="py-20 bg-muted">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto">
              {/* Beginner Questions */}
              <div className="mb-12">
                <h3 className="font-headline font-bold text-2xl text-foreground mb-6">For Beginners</h3>
                <Accordion type="single" collapsible className="space-y-4">
              ...
              {/* Course Questions */}
              <div className="mb-12">
                <h3 className="font-headline font-bold text-2xl text-foreground mb-6">About Courses</h3>
                <Accordion type="single" collapsible className="space-y-4">
              ...
              {/* Equipment Questions */}
              <div>
                <h3 className="font-headline font-bold text-2xl text-foreground mb-6">About Equipment</h3>
                <Accordion type="single" collapsible className="space-y-4">
      ...
      <AnimatedSection>
        <section className="py-20 bg-gradient-cta bg-cover bg-center bg-fixed text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="font-headline font-bold text-4xl mb-6">Still Have Questions?</h2>
