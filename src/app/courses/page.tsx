    ...
    <div>
      ...
      <section className="pt-32 pb-16 bg-gradient-cta bg-cover bg-center">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-headline font-bold text-4xl sm:text-5xl text-white mb-4">Courses & Services</h1>
        ...
        <section className="py-12 md:py-20 bg-muted">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-12">
                <h3 className="font-headline font-bold text-xl md:text-2xl text-foreground mb-6 flex items-center">
                ...
                <div className="ml-6 md:ml-12 space-y-6">
                  <div className="bg-card p-6 rounded-xl shadow-md">
                    <h4 className="font-headline font-semibold text-lg sm:text-xl text-foreground mb-3">Day 1-2: Introduction & Ground Handling</h4>
                  ...
                  <div className="bg-card p-6 rounded-xl shadow-md">
                    <h4 className="font-headline font-semibold text-lg sm:text-xl text-foreground mb-3">Day 3-4: Small Hill Training</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start">
                        <Check className="text-accent mr-2 h-4 w-4 mt-1 flex-shrink-0" />
                  ...
                  <div className="bg-card p-6 rounded-xl shadow-md">
                    <h4 className="font-headline font-semibold text-lg sm:text-xl text-foreground mb-3">Day 5: Certification & Assessment</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start">
                        <Check className="text-accent mr-2 h-4 w-4 mt-1 flex-shrink-0" />
              ...
              <div className="mb-12">
                ...
                <div className="ml-6 md:ml-12 space-y-6">
                  <div className="bg-card p-6 rounded-xl shadow-md">
                    <h4 className="font-headline font-semibold text-lg sm:text-xl text-foreground mb-3">Day 1-2: Advanced Theory & Flight Planning</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start">
                        <Check className="text-accent mr-2 h-4 w-4 mt-1 flex-shrink-0" />
                  ...
                  <div className="bg-card p-6 rounded-xl shadow-md">
                    <h4 className="font-headline font-semibold text-lg sm:text-xl text-foreground mb-3">Day 3-5: Ridge Soaring & Thermaling</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start">
                        <Check className="text-accent mr-2 h-4 w-4 mt-1 flex-shrink-0" />
                  ...
                  <div className="bg-card p-6 rounded-xl shadow-md">
                    <h4 className="font-headline font-semibold text-lg sm:text-xl text-foreground mb-3">Day 6-7: Cross-Country Introduction & Certification</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start">
                        <Check className="text-accent mr-2 h-4 w-4 mt-1 flex-shrink-0" />
              ...
              <div>
                ...
                <div className="ml-6 md:ml-12 space-y-6">
                  <div className="bg-card p-6 rounded-xl shadow-md">
                    <h4 className="font-headline font-semibold text-lg sm:text-xl text-foreground mb-3">Day 1-3: Advanced Theory & Safety Training</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start">
                        <Check className="text-accent mr-2 h-4 w-4 mt-1 flex-shrink-0" />
                  ...
                  <div className="bg-card p-6 rounded-xl shadow-md">
                    <h4 className="font-headline font-semibold text-lg sm:text-xl text-foreground mb-3">Day 4-6: SIV Course & Advanced Maneuvers</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start">
                        <Check className="text-accent mr-2 h-4 w-4 mt-1 flex-shrink-0" />
                  ...
                  <div className="bg-card p-6 rounded-xl shadow-md">
                    <h4 className="font-headline font-semibold text-lg sm:text-xl text-foreground mb-3">Day 7-10: Cross-Country Flying & Certification</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start">
                        <Check className="text-accent mr-2 h-4 w-4 mt-1 flex-shrink-0" />
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="md:w-1/2">
                <Image
                  src="https://images.unsplash.com/photo-1589802829985-817e51171b92?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
              ...
              <div className="md:w-1/2">
                <h2 className="font-headline font-bold text-3xl md:text-4xl text-foreground mb-6">Safety First</h2>
      ...
      <AnimatedSection>
        <section className="py-20 bg-gradient-cta bg-cover bg-center bg-fixed text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="font-headline font-bold text-3xl md:text-4xl mb-6">Ready to Start Your Paragliding Journey?</h2>
