        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://www.facebook.com/geparagliding/" className=" text-background/80 hover:text-primary transition " target="_blank">
              ...
              <a href="https://www.instagram.com/goldeneagleparagliding/?hl=en" className="text-background/80 hover:text-primary transition" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.youtube.com/@Golden_eagle_paraglaiding/" className="text-background/80 hover:text-primary transition" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <div>
              <p className="flex items-center mb-2">
                ...
                <a href="tel:+917590070900" className="hover:underline">
                  +91 7590070900
                </a>
              </p>
              <p className="flex items-center mb-2">
                <Phone className="text-primary mr-3 h-4 w-4" />
                <a href="tel:+919816577607" className="hover:underline">
                  +91 9816577607
                </a>
              </p>
              <p className="flex items-center mb-2">
                <Mail className="text-primary mr-3 h-4 w-4" />
                <a href="mailto:info@geparagliding.org" className="hover:underline">
                  info@geparagliding.org
                </a>
              </p>
              <p className="flex items-center mb-2">
                <Mail className="text-primary mr-3 h-4 w-4" />
                <a href="mailto:sunny_aero_7@yahoo.com" className="hover:underline">
                  sunny_aero_7@yahoo.com
                </a>
              </p>
              <p className="flex items-center mb-2">
                <Mail className="text-primary mr-3 h-4 w-4" />
                <a href="mailto:sunnyaero7@gmail.com" className="hover:underline">
                  sunnyaero7@gmail.com
                </a>
              </p>
